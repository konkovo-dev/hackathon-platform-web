              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    variant="search"
                    defaultValue="Результаты поиска"
                  />
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <Card>
              ...
              <CardContent className="flex flex-wrap items-center gap-6">
                ...
                <div className="flex items-center gap-3">
                  <Icon
                    src="/icons/icon-settings/icon-settings-md.svg"
                    size="md"
                    color="secondary"
                  />
                  <Typography variant="body-sm-regular" className="text-text-secondary">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <MenuItem
                  href="/profile"
                  iconSrc="/icons/icon-profile/icon-profile-md.svg"
                  title="profile"
                />
                <MenuItem
                  href="/my-teams"
          ...
          <Card>
            <CardContent>
              <ChipList>
                ...
                />
                <Chip label="secondary link" variant="secondary" href="https://example.com" />
              </ChipList>
            </CardContent>
          </Card>
        </section>
