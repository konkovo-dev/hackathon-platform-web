...
import { clearAuthCookies, getRefreshTokenFromCookies, setAuthCookies } from '@/shared/lib/auth/server'
...
export async function POST() {
  ...
  if (!refreshToken) {
    return NextResponse.json({ message: 'No refresh token', code: 'AUTH_REQUIRED' }, { status: 401 })
  }
