...
export async function validateHackathon(hackathonId: string): Promise<ValidateHackathonResponse> {
  return platformFetchJson<ValidateHackathonResponse>(`/v1/hackathons/${hackathonId}/validate`, {
    method: 'GET',
  })
}
